...
export const conceptDiagrams: Record<string, DiagramSpec> = {
  'viz-pipeline': {
    ...
    nodes: [
      { id: 'D', label: 'Data\n(measurements)', x: 0.08, y: 0.40, w: 170, h: 62, variant: 'primary' },
      { id: 'E', label: 'Encoding\n(marks + channels)', x: 0.28, y: 0.40, w: 190, h: 62, variant: 'primary' },
      { id: 'P', label: 'Perception\n(attention + comparison)', x: 0.48, y: 0.40, w: 205, h: 62, variant: 'primary' },
      { id: 'I', label: 'Interpretation\n(meaning + story)', x: 0.68, y: 0.40, w: 205, h: 62, variant: 'primary' },
      { id: 'A', label: 'Action\n(decision)', x: 0.88, y: 0.40, w: 170, h: 62, variant: 'primary' },
      { id: 'Y', label: 'Wrong transform\n(counts vs rates)', x: 0.08, y: 0.80, w: 190, h: 62, variant: 'warn' },
      { id: 'X', label: 'Wrong channel\nor wrong scale', x: 0.28, y: 0.80, w: 190, h: 62, variant: 'warn' },
      { id: 'Z', label: 'Overload\n(too much to compare)', x: 0.48, y: 0.80, w: 210, h: 62, variant: 'warn' },
    ],
    edges: [
      { from: 'D', to: 'E' },
      { from: 'E', to: 'P' },
